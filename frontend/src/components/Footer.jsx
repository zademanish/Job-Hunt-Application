...
<div className=" bg-gray-800">
  {/* <div><h1 className="mx-8 text-5xl text-white md:text-center pt-8 font-bold">Footer</h1></div> */}
    <div className="md:max-w-2xl mx-8 py-4 md:mx-40 text-white ">
                <div className="flex items-center">
                    <img src={logo} className="w-24 md:w-18"/>
                    <div>
                        <h1 className="text-5xl font-bold">JOB<span className="text-red-600">HUNT </span> </h1>
                    </div>
                </div>
                <h2 className="mx-2 text-4xl font-bold mt-10">Contact us</h2>
                <div className="">
